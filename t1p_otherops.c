		...
		bool project)
{
	...
	for (i=0;i<size;i++){
	    ...
	    // proposed fix for test7_2.c and for test29.c
	    if(!t1p_is_bottom(man, a)) itv_set_top(res->box[tdim[i]]);
	}
    }
    return res;
}
    ...
    // TODO TODO TODO : est ce que cette fonction sert tjs ?
{
    ...
    /* on admet que les formes sont affines autrement dit pas r�duite � un intervalle avec une borne infinie */
